...
/* Nanvix: test_popen disabled - requires std.popen() which is not supported
function test_popen()
{
...
/* Nanvix: test_os disabled - requires os.exec(), os.mkdir(), os.symlink(), etc. which are not supported
function test_os()
{
...
/* Nanvix: test_os_exec disabled - requires os.exec(), os.pipe(), os.waitpid(), os.kill() which are not supported
